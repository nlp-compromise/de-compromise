(function (global, factory) {
  ...
  */
  ...
  let { presentTense: presentTense$1, pastTense: pastTense$1, subjunctive1: subjunctive1$1, subjunctive2: subjunctive2$1, imperative: imperative$1 } = model$2;
  ...
  const toImperative = (str) => doEach(str, imperative$1);
  ...
  let { presentTense, pastTense, subjunctive1, subjunctive2, imperative } = model$2;
  ...
  var methods = {
    verb: {
      all,
      toPresent, toPast, toSubjunctive1, toSubjunctive2, toImperative,
      fromPresent, fromPast, fromSubjunctive1, fromSubjunctive2, fromImperative,
    }
  };
  ...
  Object.keys(lexData).forEach(tag => {
    ...
    Object.keys(wordsObj).forEach(w => {
      ...
      if (tag === 'Infinitive') {
        ...
        addWords(obj, 'Subjunctive1', lexicon$1);
        obj = toSubjunctive2(w);
        addWords(obj, 'Subjunctive2', lexicon$1);
        // add imperative
        obj = toImperative(w);
