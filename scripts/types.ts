...
import deCompromise from '../'
import tape from 'tape'
console.log('\n 🥗  - running types-test..\n')

tape('misc functions', function (t) {
  let doc = deCompromise('John and Joe walked to the store')
  ...
  let net = deCompromise.buildNet(matches)
  doc = deCompromise(`so good by now. woo hoo before now. in the 2nd quarter 2022`)
  let sr = doc.sweep(net)

  // lazy
  doc = deCompromise.lazy('hello', 'foo')
